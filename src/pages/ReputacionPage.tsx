    ...
    <main className="flex-1 flex flex-col overflow-y-auto no-scrollbar bg-brand-dark">
      <header className="sticky top-0 z-10 flex items-center justify-between px-8 py-4 bg-brand-dark/80 backdrop-blur-md border-b border-white/5">
        <div>
          ...
          <p className="text-[10px] text-gray-500">Monitorea tu nivel de confianza, calificaciones y comportamiento dentro de la plataforma.</p>
        </div>
                ...
                <div className="relative w-28 h-28">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center">
                    ...
                    <div className="flex items-center space-x-0.5 mt-1">
                      {[1, 2, 3, 4, 5].map((s) => (
                        <svg key={s} className={`w-3 h-3 ${s <= 4 ? "text-brand-purple" : "text-gray-600"}`} fill="currentColor" viewBox="0 0 20 20">
